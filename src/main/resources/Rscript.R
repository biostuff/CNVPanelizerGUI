...
referenceDirectory <- args[1]
sampleDirectory <- args[2]
bedFilepath <- args[3]
ampliconColumnNumber <-  as.integer(args[4])
removePcrDuplicates <- as.logical(args[5])
outputDirectory <- args[6]
numberOfBootstrapReplicates <- 10000
replicates <- numberOfBootstrapReplicates

print(paste0("referenceDirectory                :  ", referenceDirectory))
